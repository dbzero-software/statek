...
MESSAGE_DISPATCHER_SYSTEM_PROMPT = """You are an intelligent Message Dispatcher. Your goal \
is to analyze an incoming user message and determine if it belongs to an existing conversation \
thread or requires a new one.
